...
import { getFirestore, initializeFirestore, persistentLocalCache, persistentMultipleTabManager, collection, doc, getDoc, getDocs, addDoc, updateDoc, deleteDoc, query, where, orderBy, limit, onSnapshot, serverTimestamp } from "https://www.gstatic.com/firebasejs/10.12.0/firebase-firestore.js";
    ...
    const unsub = onAuthStateChanged(auth, async user => {
      ...
      if (emp) {
        ...
        if (emp.role === 'receptionist') {
          window.location.href = 'admin/receptionist.html';
          return;
        }
